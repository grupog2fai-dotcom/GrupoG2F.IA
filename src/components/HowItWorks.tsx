        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
            {steps.map((step, i) => (
              ...
              >
                <span className="block text-5xl font-bold text-[#1a1a1a] mb-6"
                  style={{ fontFamily: 'var(--font-clash)' }}>
                  {step.num}
                </span>
      ...
      <section id="resultados" className="py-24 md:py-36 bg-white">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <h2 className="text-[clamp(2rem,5vw,3.5rem)] font-semibold text-zinc-950 leading-[1.05]"
              style={{ fontFamily: 'var(--font-clash)' }}>
              Design With Purpose.{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              ...
              >
                <div className="bg-[#f84f1d] text-white text-xs font-bold px-3 py-1.5 rounded-sm self-start uppercase tracking-widest"
                  style={{ fontFamily: 'var(--font-clash)' }}>
                  {t.result}
                </div>
                <blockquote className="text-xl text-zinc-800 leading-relaxed flex-1"
                  style={{ fontFamily: 'var(--font-clash)', fontWeight: 400 }}>
                  &ldquo;{t.quote}&rdquo;
                </blockquote>
                <div className="flex items-center gap-3 pt-4 border-t border-zinc-100">
                  <div className="w-10 h-10 rounded-full bg-zinc-950 flex items-center justify-center text-white text-sm font-bold"
                    style={{ fontFamily: 'var(--font-clash)' }}>
                    {t.name[0]}
                  </div>
                  <div>
                    <p className="text-zinc-950 font-bold text-sm" style={{ fontFamily: 'var(--font-clash)' }}>{t.name}</p>
